...
2. `DatabaseService` - 77 edges
3. `DatabaseApiClient` - 69 edges
4. `DatabaseApiClient` - 67 edges
5. `TestClient` - 67 edges
6. `ApiError` - 66 edges
7. `DatabaseService` - 65 edges
8. `ApiError` - 63 edges
9. `TransportType` - 59 edges
10. `BackendService` - 58 edges
...
- 1-file cycle: `student-1/database/database_service/app.py -> student-1/database/database_service/app.py`
- 1-file cycle: `student-1/frontend/frontend_service/app.py -> student-1/frontend/frontend_service/app.py`
- 1-file cycle: `student-2/backend/backend_service/app.py -> student-2/backend/backend_service/app.py`
- 1-file cycle: `student-2/backend/backend_service/itinerary_client.py -> student-2/backend/backend_service/itinerary_client.py`
- 1-file cycle: `student-2/backend/backend_service/client.py -> student-2/backend/backend_service/client.py`
...
- 1-file cycle: `student-2/backend/backend_service/routers/accommodation.py -> student-2/backend/backend_service/routers/accommodation.py`
- 1-file cycle: `student-2/backend/backend_service/errors.py -> student-2/backend/backend_service/errors.py`
- 1-file cycle: `student-2/database/database_service/app.py -> student-2/database/database_service/app.py`
- 1-file cycle: `student-2/database/database_service/dependencies.py -> student-2/database/database_service/dependencies.py`
- 1-file cycle: `student-2/database/database_service/routers/accommodation.py -> student-2/database/database_service/routers/accommodation.py`
- 1-file cycle: `student-2/database/database_service/schemas.py -> student-2/database/database_service/schemas.py`
- 1-file cycle: `student-2/database/database_service/models.py -> student-2/database/database_service/models.py`
- 1-file cycle: `student-2/database/database_service/errors.py -> student-2/database/database_service/errors.py`
- 1-file cycle: `student-2/database/database_service/repository.py -> student-2/database/database_service/repository.py`
- 1-file cycle: `student-2/frontend/frontend_service/app.py -> student-2/frontend/frontend_service/app.py`
